...
export class ChatResponseModel extends Disposable implements IChatResponseModel {
	...
	cancel(): void {
		console.warn(`[axon-debug][response-cancel] ChatResponseModel.cancel session=${this.session.sessionResource.toString()} requestId=${this.requestId}\nstack:`, new Error().stack);
...
export class ChatModel extends Disposable implements IChatModel {
	...
	cancelRequest(request: ChatRequestModel): void {
		console.warn(`[axon-debug][model-cancel] ChatModel.cancelRequest session=${this.sessionResource.toString()} requestId=${request.id}\nstack:`, new Error().stack);
		if (request.response) {
