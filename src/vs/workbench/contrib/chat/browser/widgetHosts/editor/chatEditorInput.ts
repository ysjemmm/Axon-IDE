...
export class ChatEditorInput extends EditorInput implements IEditorCloseHandler {
	...
	updateModel(model: IChatModel): void {
		console.warn(`[axon-debug][input-update-model] ChatEditorInput.updateModel oldRef=${this._sessionResource?.toString()} newSession=${model.sessionResource.toString()}\nstack:`, new Error().stack);
