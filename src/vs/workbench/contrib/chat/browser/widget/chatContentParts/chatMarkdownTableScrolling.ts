 ...
 *
 * The returned store removes each registered layout participant when disposed,
 * so a re-rendered markdown block does not leave stale `scanDomNode` callbacks
 * pointing at detached scrollables.
 */
